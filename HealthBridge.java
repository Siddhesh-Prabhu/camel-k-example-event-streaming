...
// camel-k: dependency=github:openshift-integration:camel-k-example-event-streaming:0.0.1
...
public class HealthBridge extends RouteBuilder {
    ...
    public void configure() throws Exception {
        from("kafka:health-data?brokers={{kafka.bootstrap.address}}&groupId=healthbrige&autoOffsetReset=earliest")
